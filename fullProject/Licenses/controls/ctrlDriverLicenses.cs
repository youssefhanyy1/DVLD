...
namespace fullProject.Licenses.controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfoPersonID(int PersonID)
        {
            _Driver = clsDriver.FindByPersonID(PersonID);

            if (_Driver == null)
            {
                MessageBox.Show($"There Is no Driver linked to Person with ID:{PersonID}", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Clear();
                return;
            }
